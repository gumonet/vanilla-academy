...
app.innerHTML =
	`<div class="row">
		${monsters.map(function (monster) {
			return `
				<div class="grid">
					<img alt="${monster.alt}" src="https://gist.githubusercontent.com/cferdinandi/14e80a8e5383d962d4ac65386406993b/raw/9f34ac3b4676e4ce62d51fe7c9b06845e4657f10/${monster.name}.svg">
				</div>`;
		}).join('')}
	</div>`;